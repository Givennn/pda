...
import com.panda.pda.app.databinding.FragmentProblemDetailRecordBinding
 ...
 */
class ProblemDetailRecordFragment: BaseFragment(R.layout.fragment_problem_detail_record) {

    private val bindingAdapter by lazy { createRecordAdapter() }
    private val viewBinding by viewBinding<FragmentProblemDetailRecordBinding>()
