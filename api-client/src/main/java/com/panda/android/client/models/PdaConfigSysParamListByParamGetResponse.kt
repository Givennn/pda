...
data class PdaConfigSysParamListByParamGetResponse(
    @Json(name = "code") @field:Json(name = "code") var code: Int,
    @Json(name = "message") @field:Json(name = "message") var message: String,
    @Json(name = "data") @field:Json(name = "data") var `data`: Data1? = null
)
