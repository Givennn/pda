...
import com.panda.pda.mes.databinding.FragmentQualityReviewVerifyBinding
...
import com.panda.pda.mes.operation.qms.data.model.QualityTaskReviewRequest
...
class QualityReviewVerifyFragment : BaseFragment(R.layout.fragment_quality_review_verify) {
    ...
    private var verifyResult: Pair<String, Int>? = null
