...
import com.panda.pda.mes.databinding.FragmentQualityDistributeDistributeBinding
...
import com.panda.pda.mes.operation.qms.data.model.QualityTaskDistributeRequest
...
class QualityDistributeDistributeFragment :
    ...
    private fun updateVerifier(verifier: OrgNodeModel) {
        ...
        Timber.e(selectedVerifier?.id.toString())
