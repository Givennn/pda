 ...
 */
class WorkOrderDetailFragment: BaseFragment(R.layout.fragment_quality_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val detail = arguments?.getStringObject<WorkOrderDetailDiscoveryModel>()
            ...
            viewPage.adapter = object : FragmentStateAdapter(parentFragmentManager, lifecycle) {
                ...
                override fun createFragment(position: Int): Fragment {
                    return when (position) {
                        0 -> WorkOrderDetailInfoFragment(detail)
