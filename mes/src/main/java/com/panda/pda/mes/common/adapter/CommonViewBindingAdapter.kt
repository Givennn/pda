package com.panda.pda.mes.common.adapter
 ...
 */
abstract class CommonViewBindingAdapter<TBinding : ViewBinding, TSource>(val dataSource: MutableList<TSource> = mutableListOf()) :
